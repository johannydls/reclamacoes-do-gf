...
reclamacoes_l3 = reclamacoes_l %>% filter((polaridade <= 10))

summary(reclamacoes_l)
...
lm1 = lm(insatisfacao ~ lexico.dummy + comprimento_reclamacao, data = reclamacoes_l)
lm2 = lm(erro ~ palavras + avaliadores, data=reclamacoes_l)
```
